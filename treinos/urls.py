...
urlpatterns = [
    ...
    path('api/rem_ex_treino/<int:treino_id>/<int:exercicio_id>/', treino_views.remover_exercicio_treino, name='remover_exercicio_treino'),
    path('finalizar/<int:treino_id>/', treino_views.finalizar_treino, name='finalizar_treino'),
    path('historico/novo/<int:treino_id>/', treino_views.detalhe_treino, name='detalhe_treino'),
    path('historico/antigo/<int:treino_id>/', treino_views.detalhe_treino_antigo, name='detalhe_treino_antigo'),
    path('add_ex_treino/<int:treino_id>/<int:exercicio_id>/', views.adicionar_exercicio_treino, name='adicionar_exercicio_treino'),
]